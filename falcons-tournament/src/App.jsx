...
<style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700;800&family=DM+Mono&display=swap'); * { box-sizing: border-box; } .score-input { width: 40px; height: 34px; text-align: center; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12); border-radius: 8px; color: #e8f0ff; font-size: 15px; font-weight: 700; font-family: 'DM Mono', monospace; outline: none; -moz-appearance: textfield; } .score-input::-webkit-outer-spin-button, .score-input::-webkit-inner-spin-button { -webkit-appearance: none; } .score-input:focus { border-color: rgba(100,160,255,0.5); background: rgba(100,160,255,0.08); } .score-input:disabled { opacity: 0.45; cursor: not-allowed; } .advance-btn { width: 100%; padding: 14px; border-radius: 14px; border: none; cursor: pointer; font-family: 'DM Sans', sans-serif; font-size: 15px; font-weight: 700; transition: all 0.15s; } .advance-btn:disabled { background: rgba(255,255,255,0.05); color: #3a4a6a; cursor: not-allowed; } .advance-btn:not(:disabled) { background: linear-gradient(135deg,#1d6aff,#0a4adf); color: white; } .advance-btn:not(:disabled):hover { transform: translateY(-1px); box-shadow: 0 6px 24px rgba(29,106,255,0.3); } .team-input { width: 100%; padding: 9px 12px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; color: #c8d8f0; font-size: 13px; font-family: 'DM Sans', sans-serif; outline: none; margin-bottom: 8px; } .team-input:focus { border-color: rgba(100,160,255,0.4); background: rgba(100,160,255,0.06); } .team-input:disabled { opacity: 0.45; cursor: not-allowed; } .phase-pill { padding: 6px 16px; border-radius: 99px; font-size: 12px; font-weight: 600; transition: all 0.15s; border: none; font-family: 'DM Sans', sans-serif; } .phase-pill:not(:disabled):hover { filter: brightness(1.15); } .pw-input { width: 100%; padding: 11px 14px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12); border-radius: 10px; color: #e8f0ff; font-size: 15px; font-family: 'DM Mono', monospace; outline: none; letter-spacing: 0.1em; } .pw-input:focus { border-color: rgba(100,160,255,0.5); background: rgba(100,160,255,0.08); } .pw-input.error { border-color: rgba(248,113,113,0.6); background: rgba(248,113,113,0.05); }`}</style>
